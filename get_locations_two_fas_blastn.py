...
# Compare the sequences from two fasta files
# 2015.11.29
...
for i in range(len(title_list1)):
    for j in range(len(title_list2)):
        f1=open('01.fa','w')
        f2=open('02.fa','w')
        seq1=fa_dict1[title_list1[i]]
        seq2=fa_dict2[title_list2[j]]
        f1.write('>'+title_list1[i]+'\n'+seq1)
        f2.write('>'+title_list2[j]+'\n'+seq2)
        f1.close()
        f2.close()
